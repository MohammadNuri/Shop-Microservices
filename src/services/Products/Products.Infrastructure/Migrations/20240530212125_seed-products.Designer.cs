...
namespace Products.Infrastructure.Migrations
{
    ...
    [Migration("20240530212125_seed-products")]
            ...
            modelBuilder.Entity("Products.Domain.Categories.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 5, 30, 21, 21, 25, 581, DateTimeKind.Utc).AddTicks(9581));
                    ...
                    b.Property<DateTime>("ModificationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 5, 30, 21, 21, 25, 581, DateTimeKind.Utc).AddTicks(9900));
            ...
            modelBuilder.Entity("Products.Domain.Products.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 5, 30, 21, 21, 25, 581, DateTimeKind.Utc).AddTicks(2983));
                    ...
                    b.Property<DateTime>("ModificationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 5, 30, 21, 21, 25, 581, DateTimeKind.Utc).AddTicks(3351));
